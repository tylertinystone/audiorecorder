...
public sealed class TrayApplicationContext : ApplicationContext
{
    ...
    private void StartRecording(object? sender, EventArgs? e)
    {
        ...
        {
            var liveHandle = captureMode == CaptureTargetMode.SpecificWindow ? selectedWindow!.Handle : 0;
            started = liveRecorder.Start(dialog.FileName, captureMode, liveHandle, selectedWindow?.Title, liveSettings);
            if (started)
            {
